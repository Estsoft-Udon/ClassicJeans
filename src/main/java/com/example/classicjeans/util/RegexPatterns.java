...
//    public static final String SUMMARY_EVALUATION_PATTERN = "### 종합 평가 \\(summaryEvaluation\\):?\\s*\\n([\\s\\S]*?)\\n### 개선 방법";
//    public static final String IMPROVEMENT_SUGGESTIONS_PATTERN = "### 개선 방법 \\(improvementSuggestions\\)[\\s\\S]*?(\\d+\\.\\s.*?)(?=\\n$|$)";

    public static final String SUMMARY_EVALUATION_PATTERN = "### 종합 평가 \\(Summary Evaluation\\):?\\s*\\n([\\s\\S]*?)\\n### 개선 방법";
